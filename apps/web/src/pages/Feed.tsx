  ...
  return (
    <div className="max-w-7xl mx-auto p-4 min-h-screen">
      ...
      <div className="flex flex-col md:flex-row gap-8 items-start">
        ...
        <aside
          className={`md:w-64 flex-shrink-0 space-y-8 ${
            showMobileFilters ? "block" : "hidden md:block"
          } md:sticky md:top-24`}
        >
          <div className="border-2 border-black p-5 hard-shadow bg-white">
            <div className="flex justify-between items-end mb-6">
              <h2 className="font-display font-black text-2xl uppercase tracking-tighter leading-none">
                Filter Rig
              </h2>
            ...
            {/* Department */}
            <div className="mb-8">
              <h3 className="font-bold uppercase border-b-2 border-black mb-4 pb-1 text-base">
                Department
              </h3>
              ...
              <div className="flex flex-col gap-3">
                {Object.values(ProductCategory).map((cat) => (
                  ...
                  >
                    ...
                    <span
                      className={`uppercase ${
                        selectedCategories.includes(cat) ? "font-bold" : ""
                      }`}
                    >
                      {cat}
                    </span>
              ...
              <div className="grid grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                {products.map((product) => (
                  <ProductCard
                    ...
                    onAddToFit={addToFit}
                    isStashed={
                      !!stashedProducts.find((p) => p.id === product.id)
                    }
                  />
                ))}
              </div>
