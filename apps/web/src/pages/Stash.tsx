...
export const Stash: React.FC<StashProps> = ({ stashedProducts, savedOutfits, setSavedOutfits, toggleStash: _toggleStash, addToFit, currentOutfitItems, setCurrentOutfitItems, saveOutfit }) => {
  ...
  const grouped = useMemo(() => {
    ...
    for (const p of stashedProducts) {
      const parentRaw = ((p as unknown as Record<string, unknown>).parentCategory as string) || '';
